...
# fmdemod without arctan
def fmDemod_WO_Arctan(I, Q, prev_I=0.0, prev_Q=0.0):
        ...
        for k in range(len(I)):
                ...
                fm_demod[k] = numerator/denominator if denominator != 0 else 0

                # save the state of the current I and Q
